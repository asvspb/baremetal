...
| [ROADMAP-SPLIT-ADAPT.md](ROADMAP-SPLIT-ADAPT.md) | Порядок исполнения SPLIT-ADAPT-SPEC: баги (parted resizepart) + адаптация к новой разметке (p8 Distr → /home на p9) | 🆕 к выполнению (A0–A6) |
...
| [SPLIT-ADAPT-SPEC.md](SPLIT-ADAPT-SPEC.md) | Адаптация split-home.sh к новой разметке NVMe (появился p8 `Distr` 99 ГБ; /home → новый p9 ~328 ГБ) | 🆕 к выполнению (A1–A6) |
...
| [CODER-PROMPT-SPLIT-ADAPT.md](CODER-PROMPT-SPLIT-ADAPT.md) | Промпт исполнителя по SPLIT-ADAPT (баги + адаптация к новой разметке) | 🆕 парный |
